...
- Hoe ging de samenwerking?
  Samenwerking ging goed er waren duidelijke taken gegeven en gecommuniceerd via teams.

- Hebben we de doelen behaald die in ons teamcanvas staat?
Ons doel was een website gebouwt hebben met sveltekit voor 18 september. Dit hebben we behaald🥳🥳🥳.

- Wat zouden we de volgende keer beter willen doen als team?
  Meer duidelijke schetsen van het eindresultaat zodat het werken naar onze einddoel makkelijker en sneller gedaan wordt.
  
- Welke code conventies hebben we toegepast?
  We hebben CONTRIBUTING.md gevolgd
...
Kate: Werkt hard en fijne communicatie via teams
Luka: Communicatief sterk, heeft een taakgerichte instelling
- Welke tips heb je voor mij
Angel: Duidelijk aangeven wat je gaat doen en waarmee je bezig bent (we hadden vaak communicatie verschil dit zouden we kunnen voorkomen met standups voor de volgende keer)
Kate: Proberen vaker op tijd te komen
Luka: Probeer iets  duidelijker te documenteren
- Wat zou ik moeten veranderen om prettiger samen te werken
Angel: Comments schrijven bij bepaalde code voor meer duidelijkheid.
Kate: Aangeven waar je aan werkt
Luka: Vaker aanwezig zijn
- Waar ben je trots op?
Angel: Al het werk dat je hebt afgekregen, netjes gewerkt, goeie doorzettingsvermogen.
Kate: Dat je zo snel zo veel hebt gedaan
Luka: Je onderneemt snel actie als je merkt dat er nog iets gedaan moet worden of als je iets hebt gemist.
